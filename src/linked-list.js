...
class LinkedList {
  ...
  contains(value) {
    ...
    const searchLinkedList = (node) => {
      ...
      // base case 2: we've reached the end of the linked list and no match
      if (node.next === null) return false;
      // call out function recursivel, passing it the next node in our linked list
